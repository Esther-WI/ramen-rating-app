...
function displayRamenDetails(ramen) {
  ...
  details.innerHTML = `
    ...
    <p><strong>Rating:</strong> <span id="rating-display">${
      ramen.rating || "No rating available"
    }</span></p>
    <p><strong>Comment:</strong> <span id="comment-display">${
      ramen.comment || "No comments available"
    }</span></p>
`;
  ...
  editForm.innerHTML = `
    ...
    <input type="number" id="new-rating" min="1" max="5" value="${
      ramen.rating || ""
    }">
